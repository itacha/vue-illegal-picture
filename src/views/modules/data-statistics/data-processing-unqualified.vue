  ...
  <div style="padding:30px">
    ...
    <!-- 表格区 -->
     <el-table :data="tableData" style="width: 100%;margin-top:30px;" show-summary>
      ...
      <el-table-column prop="address" label="不合格总数"></el-table-column>
      <el-table-column prop="address" label="车牌错误数（组）"></el-table-column>
      <el-table-column prop="address" label="不属于违法行为数（组）"></el-table-column>
      <el-table-column prop="address" label="其他（组）"></el-table-column>
    </el-table>
